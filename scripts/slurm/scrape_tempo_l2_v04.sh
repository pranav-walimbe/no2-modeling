...
python -c 'from config import TEMPO_LEVEL, TEMPO_VERSION
if (TEMPO_LEVEL, TEMPO_VERSION) != ("L2", "V04"):
    raise SystemExit(f"Expected L2 V04, found {TEMPO_LEVEL} {TEMPO_VERSION}")'
