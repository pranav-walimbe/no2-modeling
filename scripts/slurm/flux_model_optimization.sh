#!/bin/bash
#SBATCH --job-name=flux-model-opt
...
output_dir="/global/home/users/pranavwalimbe/vis/flux-model-optimization-${SLURM_JOB_ID}"
...
srun python -u -m eda.flux_model_optimization "$@" --output-dir "${output_dir}"
