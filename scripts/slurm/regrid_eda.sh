...
# The harness uses one Python process; Shapely intersections are vectorized but
# the experiment groups themselves run serially.
...
srun python -u -m eda.regrid_eda --output "logs/regrid-eda-report-${SLURM_JOB_ID}.txt" "$@"
