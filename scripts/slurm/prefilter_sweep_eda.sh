#!/bin/bash
#SBATCH --job-name=prefilter-sweep-eda
...
srun python -u -m eda.prefilter_sweep_eda \
    --workers "${SLURM_CPUS_PER_TASK}" \
    --bootstrap-replicates 500 \
    --output-dir "/global/home/users/pranavwalimbe/vis/prefilter-sweep-eda-${SLURM_JOB_ID}" \
    "$@"
