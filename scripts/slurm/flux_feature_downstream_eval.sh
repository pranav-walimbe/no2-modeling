#!/bin/bash
#SBATCH --job-name=flux-downstream
...
output_dir="/global/home/users/pranavwalimbe/vis/flux-downstream-eval-${SLURM_JOB_ID}"
...
srun python -u -m eda.flux_feature_downstream_eval --output-dir "${output_dir}" "$@"
