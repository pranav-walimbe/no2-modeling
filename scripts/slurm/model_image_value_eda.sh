#!/bin/bash
#SBATCH --job-name=model-image-value
...
srun python -u -m eda.model_image_value_eda \
    --run-dir "/global/home/users/pranavwalimbe/model_runs/delta_nox_classification_20260913_071437" \
    --workers "${SLURM_CPUS_PER_TASK}" \
    --output-dir "/global/home/users/pranavwalimbe/vis/model-image-value-${SLURM_JOB_ID}"
