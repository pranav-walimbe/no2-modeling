#!/bin/bash
#SBATCH --job-name=coherent-signal-eda
...
srun python -u -m eda.coherent_signal_eda \
    --split train \
    --sample-aois 50 \
    --workers "${SLURM_CPUS_PER_TASK}" \
    --output-dir "/global/home/users/pranavwalimbe/vis/coherent-signal-eda-${SLURM_JOB_ID}" \
    "$@"
