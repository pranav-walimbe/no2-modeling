#!/bin/bash
#SBATCH --job-name=flux-split-eval
...
output_dir="/global/home/users/pranavwalimbe/vis/flux-split-evaluation-${SLURM_JOB_ID}"
...
srun python -u -m eda.flux_split_evaluation \
    --workers "${SLURM_CPUS_PER_TASK}" \
    --output-dir "${output_dir}"

bash scripts/slurm/email_flux_dashboard.sh \
    "${output_dir}/flux_split_dashboard.png" \
    "${SLURM_JOB_ID}" \
    "${recipient}"
