...
MASKED_PRETRAINING_RUNS_DIR = "/global/home/users/pranavwalimbe/masked_model_runs/"
MASKED_PRETRAINING_IMAGE_KEYS = MODEL_IMAGE_KEYS
MASKED_PRETRAINING_TARGET_KEY = "no2"
MASKED_PRETRAINING_ORIGINAL_MASK_KEY = "no2_mask"
MASKED_PRETRAINING_ARTIFICIAL_MASK_KEY = "artificial_mask"
MASKED_PRETRAINING_TRAIN_RECORDS = 500_000
MASKED_PRETRAINING_VAL_RECORDS = 50_000
MASKED_PRETRAINING_TEST_RECORDS = 50_000
MASKED_PRETRAINING_SHARD_SIZE = 20_000
MASKED_PRETRAINING_MAX_PARALLEL_SHARDS = 8
MASKED_PRETRAINING_WORKERS_PER_SHARD = 8
MASKED_PRETRAINING_SPLIT_SEED = 42
MASKED_PRETRAINING_MIN_MASK_FRACTION = 0.01
MASKED_PRETRAINING_MAX_MASK_FRACTION = 0.10
MASKED_PRETRAINING_MASK_EDGE_STRENGTH = 2.0
MASKED_PRETRAINING_MASK_EDGE_DECAY_PIXELS = 2.0
MASKED_PRETRAINING_MASK_CLUMP_STRENGTH = 0.35
MASKED_PRETRAINING_MASK_CLUMP_SIGMA_PIXELS = 1.0
MASKED_PRETRAINING_MASK_MAX_CLUMP_MULTIPLIER = 2.0
