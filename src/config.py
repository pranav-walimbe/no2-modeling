...
DATASET_SCAN_CACHE_VERSION = 1  # increment after a cache-incompatible regridding change
DATASET_SCAN_CACHE_DIR = os.path.join(DATASET_DIR, f"scan-cache-v{DATASET_SCAN_CACHE_VERSION}")
